...
(function () {
  ...
  function render() {
    ...
    var header =
      '<h1 class="screen-title">Saved trips</h1>' +
      '<p class="screen-sub">' + dests.length + (dests.length === 1 ? ' destination' : ' destinations') + ' on your wishlist</p>';
      ...
      return '' +
        '<div class="container">' + header +
          '<div class="empty">' +
            ...
            '<p>Tap the ♡ on any trip you like and it will wait here.</p>' +
            ...
            return '' +
              '<article class="dcard" data-id="' + d.id + '">' +
                ...
                '<div class="dcard-body">' +
                  ...
                  '<div class="dcard-loc">' + T.esc(d.country) + ' · ' + cat.label + '</div>' +
